...
(function (window) {
    ...
    var Util = Base.getClass('http://atsss.cn/scripts/main/component/main.base.Util');
        ...
        var oPopup = new Popup({
            ...
            ok: function () {
                ...
                $.ajax({
                    ...
                    // 未登陆，跳转到登陆页面
                    if (oResult.code === 999) {
                        window.location.href = '../../../reglogin-next=.htm'/*tpa=http://atsss.cn/reglogin?next=*/ + window.encodeURIComponent(window.location.href);
                    } else {
